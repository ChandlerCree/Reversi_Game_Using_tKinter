...
--
-- Host: reversigroup4.cm0trrj52t1s.us-east-1.rds.amazonaws.com    Database: sys
-- ------------------------------------------------------
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-11-02 20:41:55',NULL),('diagnostics.include_raw','OFF','2021-11-02 20:41:55',NULL),('ps_thread_trx_info.max_length','65535','2021-11-02 20:41:55',NULL),('statement_performance_analyzer.limit','100','2021-11-02 20:41:55',NULL),('statement_performance_analyzer.view',NULL,'2021-11-02 20:41:55',NULL),('statement_truncate_len','64','2021-11-02 20:41:55',NULL);
...
-- Dump completed on 2022-05-02 22:24:18
...
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: reversigroup4.cm0trrj52t1s.us-east-1.rds.amazonaws.com    Database: reversi
-- ------------------------------------------------------
-- Server version	8.0.27
...
CREATE TABLE `disk` (
  ...
  KEY `game` (`game`),
  KEY `player` (`player`),
  CONSTRAINT `disk_ibfk_1` FOREIGN KEY (`game`) REFERENCES `game` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `disk_ibfk_2` FOREIGN KEY (`player`) REFERENCES `player` (`username`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `disk` VALUES (0,2,'AI',14),(0,3,'AI',14),(0,4,'AI',14),(1,2,'AI',14),(1,3,'AI',14),(2,0,'AI',14),(2,1,'AI',14),(2,2,'AI',14),(2,4,'AI',14),(3,1,'AI',14),(3,2,'AI',14),(3,3,'AI',14),(3,4,'AI',14),(3,5,'AI',14),(4,2,'AI',14),(5,2,'AI',14),(0,1,'angelo',13),(1,1,'angelo',13),(2,2,'angelo',13),(2,3,'chand',14),(2,5,'chand',14),(4,3,'chand',14),(5,3,'chand',14),(0,0,'guest',12),(0,1,'guest',12),(0,2,'guest',12),(0,3,'Guest',12),(1,1,'guest',12),(1,2,'guest',12),(1,2,'guest',13),(1,3,'Guest',12),(1,3,'guest',13),(2,1,'guest',12),(2,1,'guest',13),(2,2,'guest',12),(2,3,'Guest',12),(3,0,'guest',13),(3,1,'guest',12),(4,2,'guest',15),(4,3,'guest',12),(4,3,'guest',15),(2,3,'omar',15),(2,4,'omar',15),(2,5,'omar',15),(3,3,'omar',15),(3,4,'omar',15),(4,4,'omar',15);
...
CREATE TABLE `game` (
  ...
  `curr_player` varchar(32) DEFAULT NULL,
  `size` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `player1` (`player1`),
  KEY `player2` (`player2`),
  KEY `curr_player` (`curr_player`),
  CONSTRAINT `game_ibfk_1` FOREIGN KEY (`player1`) REFERENCES `player` (`username`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `game_ibfk_2` FOREIGN KEY (`player2`) REFERENCES `player` (`username`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `game_ibfk_3` FOREIGN KEY (`curr_player`) REFERENCES `player` (`username`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `game` VALUES (12,'Guest','guest','guest',4),(13,'angelo','guest','guest',4),(14,'chand','AI','AI',6),(15,'omar','guest','guest',8);
...
INSERT INTO `player` VALUES ('AI','AI',1500,0),('angelo','angelo',1881,36),('aoun','aoun',1500,51),('chand','chand',1737,54),('e','e',1500,0),('eleni','eleni',1840,12),('guest','guest',1475,1),('harry','harry',1270,16),('jim','jim',1360,84),('julia','julia',1500,0),('mohammed','mohammed',1676,54),('omar','omar',1740,21),('omar12','omar',1500,0),('peter','peter',1130,3),('radishco','radishco',1500,0),('roi','roi',1530,0),('sally','sally',830,14),('test1','test1',1500,0);
...
--
-- Dumping routines for database 'reversi'
--
SET @@SESSION.SQL_LOG_BIN = @MYSQLDUMP_TEMP_LOG_BIN;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2022-05-02 22:24:21
