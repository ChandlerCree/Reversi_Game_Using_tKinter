...
class LoginView(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.login_title = tk.Label(self.frame, text="REVERSI", bg=bg_2, width="20", height="1",
                                    font=("Calibri", 24, "bold"), fg=fg_1, borderwidth=4,
                                    relief="groove", pady="10")
        self.login_title.pack(pady=(0, 12))

        self.login_button = tk.Button(self.frame, text="Login", height="1", width="12", command=self.login, bg=bg_2,
                                      fg=fg_1,
                                      font=("Calibri", 18, "bold"), activebackground=cor_1)
        self.login_button.pack(pady=12)

        self.register_button = tk.Button(self.frame, text="Register", height="1", width="12", command=self.register,
                                         bg=bg_2, fg=fg_1,
                                         font=("Calibri", 18, "bold"), activebackground=cor_1)
        self.register_button.pack(pady=12)

        self.guest_login_button = tk.Button(self.frame, text="Return to Menu", height="1", width="12",
                                            command=self.logged_as_guest, bg=bg_2, fg=fg_1,
                                            font=("Calibri", 18, "bold"), activebackground=cor_1)
    ...
    def login(self):
        ...
        self.login_title = tk.Label(self.login_screen, text="REVERSI", bg=bg_2, width="20", height="1",
                                    font=("Calibri", 24, "bold"),
                                    fg=fg_1, borderwidth=4, relief="groove", pady="10")
        self.login_title.pack(pady=(0, 8))

        self.login_prompt = tk.Label(self.login_screen, text="Please enter details below to login",
                                     font=("Calibri", 12), fg=fg_1,
                                     bg=bg_1)
        ...
        self.login_button = tk.Button(self.login_screen, text="Login", width=12, height=1, fg=fg_1, bg=bg_2,
                                      font=("Calibri", 18, "bold"),
                                      command=lambda: [self.remove_verify_text(), self.login_verify()],
                                      activebackground=cor_1)
    ...
    def register(self):
        ...
        self.register_title = tk.Label(self.register_screen, text="REVERSI", bg=bg_2, width="20", height="1",
                                       font=("Calibri", 24, "bold"),
                                       fg=fg_1, borderwidth=4, relief="groove", pady="10")
        self.register_title.pack(pady=8)
        self.register_prompt = tk.Label(self.register_screen, text="Please enter details below", font=("Calibri", 12),
                                        fg=fg_1, bg=bg_1)
        ...
        self.username_label_register = tk.Label(self.register_screen, text="Username * ", font=("Calibri", 12), fg=fg_1,
                                                bg=bg_1)
        ...
        self.password_label_register = tk.Label(self.register_screen, text="Password * ", font=("Calibri", 12), fg=fg_1,
                                                bg=bg_1)
        ...
        self.register_button = tk.Button(self.register_screen, text="Register", width=12, height=1, fg=fg_1, bg=bg_2,
                                         font=("Calibri", 18, "bold"), command=self.register_user,
                                         activebackground=cor_1)
